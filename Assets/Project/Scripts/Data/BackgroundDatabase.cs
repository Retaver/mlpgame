...
public class BackgroundDatabase : MonoBehaviour
{
    ...
    private void CreateDefaultBackgrounds()
    {
        ...
        AddBackground(new Background
        {
            ...
            flavorText = "Knowledge has always been your greatest treasure. You remember countless hours reading by candlelight, discovering ancient secrets that few others know.",
        ...
        AddBackground(new Background
        {
            ...
            flavorText = "Years of training and duty have shaped you into a protector. You still remember your oath to serve and protect, even as everything changed around you.",
        ...
        AddBackground(new Background
        {
            ...
            flavorText = "The road has been your home, and you know the value of everything. But now you've found yourself in a world where old bargains no longer apply.",
        ...
        AddBackground(new Background
        {
            ...
            flavorText = "The soil under your hooves, the sun on your back, the rhythm of the seasons - that was your world until everything changed and you were transported to this strange new reality.",
        ...
        AddBackground(new Background
        {
            ...
            flavorText = "The stage was your world, the crowd your family. Every night brought new faces and new stories, but now you find yourself in the greatest story of all - your own.",
        ...
        AddBackground(new Background
        {
            ...
            flavorText = "Others always looked at you differently. You learned to rely on yourself, developing skills that others never needed to learn in this harsh new world.",
